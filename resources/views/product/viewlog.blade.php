                ...
                <table class="dt-column-search table table-bordered" id="mytable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td @if(in_array($row->type, ['stock_out', 'convert_out', 'adjust_out'])) style="color:red" @else style="color:green" @endif>@if(in_array($row->type, ['stock_out', 'convert_out', 'adjust_out'])) - @endif{{$row->quantity??""}}</td>
